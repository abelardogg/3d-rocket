...
$my_email = "contacto@3drocket.com.mx";
...
TIENES QUE CAMBIAR LOS CAMPOS DE "name" "email" "asunto" "comments" a que coincidan con los de este archivo.
...
$attachment = chunk_split(base64_encode(file_get_contents('archivo1')));
...
$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Visitanos en 3drocket.com.mx";

$message = stripslashes($message);

$subject = "3dRocket Web";
